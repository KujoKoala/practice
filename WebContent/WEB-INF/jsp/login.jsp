		...
		<DIV class=dialog>
			<DIV class=box>
				...
				<FORM id=user method=post name=user
					action=${pageContext.request.contextPath }/guanli?method=checkLogin>
					<DIV class=infos>
						<TABLE class=field>
							<TBODY>
								<TR>
								...
								<TR>
									...
									<TD>
										...
										<INPUT id=user_name class=text type=text name=user>
									</TD>
								</TR>
								<TR>
						...
						<DIV class=buttons>
							<INPUT value=登陆 type="submit"> <INPUT
								onclick='document.location="${pageContext.request.contextPath}/guanli?method=regist"'
